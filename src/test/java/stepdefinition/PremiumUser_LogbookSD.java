...
public class PremiumUser_LogbookSD {
	...
	public void user_should_see_the_carbs_card_displayed(String string) {
	    
	    
	}

	@Then("User should see the protein card  displayed {string}")
	public void user_should_see_the_protein_card_displayed(String string) {
	    
	    
	}

	@Then("User should see the fats card  displayed {string}")
	public void user_should_see_the_fats_card_displayed(String string) {
	...
	public void user_should_see_text_in_orange_color() {
	    
	    
	}

	@Then("User should see text in Red color")
	public void user_should_see_text_in_red_color() {
	    
	    
	}

	@Then("User should see y-axis  clearly labeled with the text {string}")
	public void user_should_see_y_axis_clearly_labeled_with_the_text(String string) {
	...
	public void user_should_see_total_calories_has_value(String string) {
	    
	    
	}

	@Then("User should see Daily average has {string}  value")
	public void user_should_see_daily_average_has_value(String string) {
	...
	public void user_has_not_scheduled_any_medication_for_the_week() {
	    
	    
	}

	@Then("User should see {string}  value in the Total scheduled statistics")
	public void user_should_see_value_in_the_total_scheduled_statistics(String string) {
	    
	    
	}

	@Then("User should see {string} value in the Doses taken statistics")
	public void user_should_see_value_in_the_doses_taken_statistics(String string) {
	    
	    
	}

	@Then("User should see {string} value in the Doses Missed statistics")
	public void user_should_see_value_in_the_doses_missed_statistics(String string) {
	...
	@Then("User should see table header {string},{string},{string},{string},Medication\"")
	public void user_should_see_table_header_medication(String string, String string2, String string3, String string4) {
