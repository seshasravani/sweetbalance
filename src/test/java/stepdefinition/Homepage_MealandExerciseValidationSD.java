...
import pagefactory.Homepage_MealandExerciseValidation;
import utilities.ConfigReader;
import utilities.LoggerLoad;
import webdriver.DriverFactory;


public class Homepage_MealandExerciseValidationSD{

    private WebDriver driver = DriverFactory.getDriver();
    private Homepage_MealandExerciseValidation home = new Homepage_MealandExerciseValidation(driver);
